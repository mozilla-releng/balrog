...
class TestReleasesJSON(unittest.TestCase, MemoryDatabaseMixin):
    def setUp(self):
        ...
        self.release_details = dbo.release_details
    ...
    "hashFunction": "sha512"
        ...
        self.release_details.t.insert().execute(
            name="Firefox-60.0-build1",
    ...
    "partials": [
        ...
        history_entries = []
        for k in self.release_details.history.bucket.blobs:

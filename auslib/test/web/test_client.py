...
import auslib.web.public.api as api
...
class ClientTest(ClientTestBase):
    ...
    def testGetHeaderArchitectureWindows(self):
        self.assertEqual(api.getHeaderArchitecture('WINNT_x86-msvc', 'Firefox Intel Windows'), 'Intel')

    def testGetHeaderArchitectureMacIntel(self):
        self.assertEqual(api.getHeaderArchitecture('Darwin_x86-gcc3-u-ppc-i386', 'Firefox Intel Mac'), 'Intel')

    def testGetHeaderArchitectureMacPPC(self):
        self.assertEqual(api.getHeaderArchitecture('Darwin_ppc-gcc3-u-ppc-i386', 'Firefox PPC Mac'), 'PPC')
...
""")
    ...
    def testNonSubstitutedUrlVariablesReturn404(self):
        ...
        with mock.patch('auslib.web.public.api.get_update_blob') as mock_cr_view:
...
class ClientTestWithErrorHandlers(ClientTestCommon):
    ...
    def testContentSecurityPolicyIsSetFor400(self):
        with mock.patch('auslib.web.public.api.get_update_blob') as m:
    ...
    def testSentryBadDataError(self):
        with mock.patch("auslib.web.public.api.get_update_blob") as m, mock.patch("auslib.web.public.base.sentry") as sentry:
    ...
    def testNonSubstitutedUrlVariablesReturnEmptyUpdate(self):
        ...
        with mock.patch('auslib.web.public.api') as mock_cr_view:
            for request in [request1, request2, request3, request4, request5, request6]:
                ret = self.client.get(request)
                self.assertUpdatesAreEmpty(ret)
                self.assertFalse(mock_cr_view.called)

...
"""
    ...
    def testFieldViewDiffFirstRelease(self):
        ...
        ret = self._put("/releases/ddd1", data=dict(blob=blob, name="ddd1", product="d", data_version=1))
    ...
    def testFieldViewDiffRelease(self):
        ...
        ret = self._post("/releases/b", data=dict(data=data, product="b", data_version=1))
        self.assertStatusCode(ret, 200)
        ...
        ret = self._post("/releases/b", data=dict(data=data, product="b", data_version=2))
        self.assertStatusCode(ret, 200)

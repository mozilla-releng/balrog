...
#        return response
#    return ConnexionResponse(status=404, mimetype="text/plain", response=error.description)
...
#        return ConnexionResponse(status=400, mimetype="text/plain", response=html.escape(message, quote=False))
#
...
#
#    return ConnexionResponse(status=500, mimetype="text/plain", response=html.escape(message, quote=False))

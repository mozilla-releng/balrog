...
def upgrade(migrate_engine):
    ...
    release_details_scheduled_changes = Table(  # noqa
        "release_details_scheduled_changes",
        metadata,
        Column("sc_id", Integer, primary_key=True, autoincrement=True),
        Column("scheduled_by", String(100), nullable=False),
        Column("complete", Boolean, default=False),
    ...
    release_details_scheduled_changes_history = Table(  # noqa
        "release_details_scheduled_changes_history",
        metadata,
        Column("change_id", Integer, primary_key=True, autoincrement=True),
        Column("changed_by", String(100), nullable=False),
        Column("timestamp", bigintType, nullable=False),
    ...
    release_details_scheduled_changes_conditions = Table(  # noqa
        "release_details_scheduled_changes_conditions",
        metadata,
        Column("sc_id", Integer, primary_key=True, autoincrement=True),
        Column("when", bigintType),
        Column("data_version", Integer, nullable=False),
    ...
    release_details_scheduled_changes_conditions_history = Table(  # noqa
        "release_details_scheduled_changes_conditions_history",
        metadata,
        Column("change_id", Integer, primary_key=True, autoincrement=True),
        Column("changed_by", String(100), nullable=False),
        Column("timestamp", bigintType, nullable=False),
    ...
    release_details_scheduled_changes_signoffs = Table(  # noqa
        "release_details_scheduled_changes_signoffs",
        metadata,
        Column("sc_id", Integer, primary_key=True, autoincrement=False),
        Column("username", String(100), primary_key=True),
        Column("role", String(50), nullable=False),
    ...
    release_details_scheduled_changes_signoffs_history = Table(  # noqa
        "release_details_scheduled_changes_signoffs_history",
        metadata,
        Column("change_id", Integer, primary_key=True, autoincrement=True),
        Column("changed_by", String(100), nullable=False),
        Column("timestamp", bigintType, nullable=False),
...
def downgrade(migrate_engine):
    ...
    Table("release_details", metadata, autoload=True).drop()
    Table("release_details_scheduled_changes", metadata, autoload=True).drop()
    Table("release_details_scheduled_changes_history", metadata, autoload=True).drop()
    Table("release_details_scheduled_changes_conditions", metadata, autoload=True).drop()
    Table("release_details_scheduled_changes_conditions_history", metadata, autoload=True).drop()
    Table("release_details_scheduled_changes_signoffs", metadata, autoload=True).drop()
    Table("release_details_scheduled_changes_signoffs_history", metadata, autoload=True).drop()
